...
.error-page-main:before{content:'';display:block;background:url(/static/img/errorPageBorder.png?1427783409637);height:7px;position:absolute;top:-7px;width:100%;left:0}
.error-page-main h3{font-size:24px;font-weight:400;border-bottom:1px solid #d0d0d0}
.error-page-main h3 strong{color: #fd7e1e;font-size:54px;font-weight:400;margin-right:20px;}
        ...
        <div class="error-page-main">
            ...
            <div class="error-page-actions">
                ...
                <div>
                    <h4>可以尝试：</h4>
                    <ul>
                        <li><a href="/homepage/init">返回首页</a></li>
                    </ul>
                </div>
            </div>
        </div>
